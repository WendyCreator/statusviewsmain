                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php } ?>     
                                        ...
                                        <label for="role">Search Staffs By Role:</label>
                                ...
                                <a href="view-staffs" class="btn btn-success btn-lg">Get all Staffs</a>
                            </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="row">
                            ...
                            <?php if(isset($_GET['searchstaff'])){
                                if(!empty($_GET['role'])){
                                    ...
                                    $sql = formQuery("SELECT * FROM staffs WHERE drole = '$search'");
                                    if($sql->num_rows>0){ 
                                        $num = 1;
...
<section class="col-xl-3 col-sm-6">
                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">Climax Properties <?=$row['drole']?></p>
