...
<!-- <?php # }else{ ?> -->
                        ...
                        elseif(isset($_SESSION['groupmsg']) and $_SESSION['groupmsg'] !== 'Record inserted successfully!'){ ?>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Add all Group Links</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form  action="add-group-process" method='post' enctype="multipart/form-data" >
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        <label for="productname">Group Title:</label>
                                                        <input id="productname" name="name" type="text" class="form-control" placeholder="Enter name of the Group...">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="admin">Group Admin Name:</label>
                                                        <input id="admin" name="admin" type="text" class="form-control" placeholder="Enter name of the Group Admin...">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="phone">Group Number:</label>
                                                        <input id="phone" name="phone" type="text" class="form-control" placeholder="Enter the Group Number...">
                ...
                <select name="groupcat" id="groupcat" class="form-select shadow-sm p-3">
                  ...
                  <option value="Premium">Premium</option>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="productdesc" rows="5" placeholder="Group Description" name='desc'></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="glink">Group Link</label>
                                                        <input class="form-control" id="glink" type="url" rows="5" placeholder="Group Link" name='glink'>
                                                    </div>
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="submit" class="btn btn-primary waves-effect waves-light" name='group'>Save Group</button>
