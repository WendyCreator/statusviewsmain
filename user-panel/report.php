            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php if(isset($_SESSION['reportmsg']) and $_SESSION['reportmsg'] == 'Message Sent Successfully!'){ ?>
                        ...
                        elseif(isset($_SESSION['reportmsg']) and $_SESSION['reportmsg'] !== 'Message Sent Successfully!'){ ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Report a Contact</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <!-- <li class="breadcrumb-item"><a href="javascript: void(0);">All Quotes</a></li> -->
                                            <li class="breadcrumb-item active"> Report any issues with a contact</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form  action="report-process" method='post' >
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        <label for="productname">Dafaulting Contact Name:</label>
                                                        <input id="productname" name="contactname" type="text" class="form-control" placeholder="Enter name of the Contact...">
                                                    </div>
                                                    

                                                    <div class="mb-3">
                                                        <label for="phone">Defaulting Contact Number:</label>
                                                        <div class="row">
                                                            <div class="col-3">
                  ...
                  <option value="+234">+234 &nbsp; Nigeria</option>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="mb-3">
                                                    <label for="plan" class="form-label">Reason(s) for reporting:</label>
                                                    <textarea id="report" name="report" rows="10" type="text"class="form-control" placeholder="Please state the reason for reporting..."></textarea>
                                                    <input type="hidden" value="<?=$_SESSION['email']?>" name="email">
                                                    <input type="hidden" value="<?=$_SESSION['fullname']?>" name="name">
                                                    </div>
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="submit" class="btn btn-primary waves-effect waves-light" name='contact'>Report Contact</button>
