        ...
        <?php include_once 'siderbar.php' ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <?php if(isset($_SESSION['galleryupdate']) and $_SESSION['galleryupdate'] == 'Gallery image deleted successfully'){ ?>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">View Gallery</a></li>
                                            <li class="breadcrumb-ite active"> /Gallery</li>
                                        </ol>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap table-hover">
                                                ...
                                                <?php
                                                     ...
                                                     $sql = formQuery("SELECT * FROM gallery ORDER BY id DESC");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <ul class="list-inline font-size-20 contact-links mb-0">
                                                                ...
                                                                <a href="edit-gallery?id=<?= $row['id'] ?>" class="btn btn-success waves-effect waves-light w-sm">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="delete?id=<?=$row['id']?>&gid=<?=$row['gid']?>&action=gallery" class="btn btn-danger">Yes, Delete</a>
      </div>
    </div>
  </div>
</div>
