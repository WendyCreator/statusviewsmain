    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
        ...
        <?php include_once 'siderbar.php' ?>
          ...
          if(isset($_GET['id'])){
            ...
            $sql = formQuery("SELECT * FROM ceemembers WHERE id= '$id' AND memberid = '$memberid'");
            $row = $sql->fetch_assoc();
          }
          ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <?php if(isset($_SESSION['memberedit']) and $_SESSION['memberedit'] == 'Record Updated successfully!'){ ?>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Member</a></li>
                                            <li class="breadcrumb-ite active"> /Edit Member's Profile</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <form  action="edit-member-process" method='post' enctype="multipart/form-data" >
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        <label for="productname">Member Name:</label>
                                                        <input id="productname" name="name" type="text" class="form-control" placeholder="Enter name of the Member..." value="<?=$row['fullname']?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="phone">Member Number:</label>
                                                        <input id="phone" name="phone" type="text" class="form-control" placeholder="Enter the Member Number..."  value="<?=$row['dphone']?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="email">Member Email:</label>
                                                        <input id="email" name="email" type="email" class="form-control" placeholder="Enter the Member Email..." readonly  value="<?=$row['demail']?>">
                                                    </div>
                                                    <input type="hidden" value="<?=$row['memberid']?>" name="memberid">
                                            ...
                                            <div class="dz-message needsclick">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="password" name="password" type="text" readonly class="form-control" placeholder="Enter the Member Password..."  value="<?=$row['dpassword']?>">
                                                    </div>
                                                    <div class="mb-3">
                ...
                <select name="plan" id="plan" class="form-select shadow-sm p-3">
                  ...
                  <option value="Premium">Premium</option>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="groupname" name="groupname" type="text" class="form-control" placeholder="Enter the Member Group Name..."  value="<?=$row['groupname']?>">
                                                    </div>
                                            ...
                                            <option value="<?=$row['groupcat']?>"><?=$row['groupcat']?></option>
                                                <?php
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="submit" class="btn btn-primary waves-effect waves-light" name='member'>Save Changes</button>
