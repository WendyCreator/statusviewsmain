                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">All Climax Properties External Agents</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <!-- <li class="breadcrumb-item"><a href="javascript: void(0);">Contacts</a></li> -->
                                            <li class="breadcrumb-item active">External Agents' Grid</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="col-lg-12">
                                ...
                                <?php if(isset($_SESSION['agentdelete']) and $_SESSION['agentdelete'] == 'Detail deleted successfully'){ ?>
                                           <div class="alert alert-success alert-dismissible fade show mb-2" role="alert">
                                                <?=$_SESSION['agentdelete'] ?>

                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>
                        <?php } ?>

                        <?php if(isset($_SESSION['agentdelete']) and $_SESSION['agentdelete'] === 'Could not complete this action!'){ ?>
                        ...
                        <div class="row">
                            ...
                            <?php if(isset($_POST['searchstaff'])){
                                if(!empty($_POST['userid'])){
                                    ...
                                    $sql = formQuery("SELECT * FROM externalagent WHERE duserid = '$search'");
                                    if($sql->num_rows>0){
                                       $row = $sql->fetch_assoc(); ?>
...
<section class="col-xl-3 col-sm-6">
                               ...
                               <?php     }
                                  ...
                                  $sql = formQuery("SELECT * FROM externalagent");
                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <h5 class="font-size-15 mb-1 fullname"><a href="javascript: void(0);" class="text-dark"><?= $row['firstname'].' '. $row['lastname']?></a></h5>
                                        <p class="text-muted">Climax Properties <?=$row['username']?></p>
                                        <p class="text-muted"> <?=$row['demail']?></p>
                                    ...
                                    <div class="card-footer bg-transparent border-top">
                                        <div class="contact-links d-flex font-size-20">
                                            ...
                                            <div class="flex-fill">
                                                <a href="edit-agent.php?id=<?=$row['id']?>&email=<?=$row['demail']?>"><i class="fas fa-pencil-alt"></i></a>
                                            </div>
                                            <div class="flex-fill">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="delete-agent.php?id=<?=$row['id']?>&email=<?=$row['demail']?>" class="btn btn-danger">Yes, Delete</a>
      </div>
    </div>
  </div>
</div>
...
<!-- 
    ...
    <?php unset($_SESSION['agentdelete']) ?>
