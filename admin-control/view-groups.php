                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                                ...
                                <?php if(isset($_SESSION['groupdelete']) and $_SESSION['groupdelete'] == 'Group deleted successfully'){ ?>
                                           <div class="alert alert-success alert-dismissible fade show mb-2" role="alert">
                                                <?=$_SESSION['groupdelete'] ?>

                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>
                        <?php } ?>

                        <?php if(isset($_SESSION['groupdelete']) and $_SESSION['groupdelete'] === 'Could not complete this action!'){ ?>
                        ...
                        <?php } ?>     
                            ...
                            <input type="search" class="form-control" placeholder='Filter groups by title here...' id='search'>
                                                </div>
        ...
        <section class="col-xl-3 col-sm-6">
                                ...
                                <div class="card text-center">
                                    ...
                                    <div class="card-footer bg-transparent border-top">
                                        <div class="contact-links d-flex font-size-20 d-non" >
                                            <!-- <div class="flex-fill">
                                                <a href="staff-profile?id=<?=$row['id']?>&groupid=<?=$row['groupid']?>"><i class="bx bx-message-square-dots"></i></a>
                                            </div> -->
                                            <div class="flex-fill">
                                                <a href="edit-group?id=<?=$row['id']?>&groupid=<?=$row['groupid']?>"><i class="fas fa-pencil-alt"></i></a>
                                            </div>
                                            <div class="flex-fill">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="delete-group?id=<?=$row['id']?>&groupid=<?=$row['groupid']?>" class="btn btn-danger">Yes, Delete</a>
      </div>
    </div>
  </div>
</div>
...
<!-- 
    ...
    <?php unset($_SESSION['groupdelete']) ?>
