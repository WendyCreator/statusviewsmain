...
<!-- 
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="add-blog" key="t-inbox1">Add Blog</a></li>
                    <li><a href="add-contact" key="t-inbox">Add Contact</a></li>
                    <li><a href="add-member" key="t-inbox">Add Member</a></li>
                    <li><a href="add-group" key="t-inbox">Add Group</a></li>
                    <li><a href="add-gallery" key="t-read-email">Add to gallery</a></li>
                    <li><a href="add-category" key="t-read-email">Add Category</a></li>
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="view-blogs" key="t-read-email">View Blogs</a></li>
                    <li><a href="view-verified" key="t-read-email">View Verified</a></li>
                    <li><a href="view-contacts" key="t-inbox">View Contacts</a></li>
                    <li><a href="view-members" key="t-inbox">View Members</a></li>
                    <li><a href="view-groups" key="t-inbox">View Groups</a></li>
                    <li><a href="view-gallery" key="t-read-email">View Gallery</a></li>
                    <li><a href="view-categories" key="t-read-email">View categories</a></li>
                    <li><a href="downloads" key="t-read-email">Download Contacts</a></li>
                    <li><a href="download-action" key="t-read-email">Process Contacts</a></li>
            ...
            <li>
                <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <span key="t-contacts">Staffs</span>
                </a>
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="view-admins" key="t-user-grid">View Admins</a></li>
                    <li><a href="view-staffs" key="t-user-list">View Staffs</a></li>
                    <!-- <li><a href="view-agents" key="t-user-list">View External Agent</a></li> -->
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    ...
                    <?php if($_SESSION['role'] == 'admin'){?>
                        <li><a href="auth-register" key="t-register">Register Admin</a></li>
                    <li><a href="register-staff" key="t-register-2">Register Staff</a></li>
                     <?php } ?>
