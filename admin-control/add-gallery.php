            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <!-- end page title -->
                        <?php if(isset($_SESSION['galmsg']) and $_SESSION['galmsg'] == 'Record inserted successfully!'){ ?>
                        ...
                        <?php }
                         ...
                         elseif(isset($_SESSION['galmsg']) and $_SESSION['galmsg'] !== 'Record inserted successfully!'){ ?>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="needs-validation" novalidate action="add-gallery-process" method='post' id='myform' enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        <label for="productname">Image Title</label>
                                                        <input id="productname" name="galtitle" type="text" class="form-control" placeholder="Image Title">
                                                    </div>
                                                    <!-- <div class="mb-3">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="productdesc" rows="5" placeholder="Image Description" name='galdesc'></textarea>
                                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div  class="dropzone">
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="submit" class="btn btn-primary waves-effect waves-light" name='gallery'>Save Changes</button>
