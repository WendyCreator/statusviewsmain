                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">All Status View Members</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <!-- <li class="breadcrumb-item"><a href="javascript: void(0);">Members</a></li> -->
                                            <li class="breadcrumb-item active">Members' Grid</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="col-lg-12">
                                ...
                                <?php if(isset($_SESSION['memberdelete']) and $_SESSION['memberdelete'] == 'Member deleted successfully'){ ?>
                                           <div class="alert alert-success alert-dismissible fade show mb-2" role="alert">
                                                <?=$_SESSION['memberdelete'] ?>

                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>
                        <?php } ?>

                        <?php if(isset($_SESSION['memberdelete']) and $_SESSION['memberdelete'] === 'Could not complete this action!'){ ?>
                        ...
                        <?php } ?>     
                                        ...
                                        <label for="role">Search Members by number:</label>
                                            <input name="role" id="role" class='form-control'>
                                             
                                        </div>
                                        <div class="col-4 mt-4">
                                <input type="submit" value="Search" class="btn btn-info btn-lg" name="searchstaff">
                                <a href="view-members" class="btn btn-success btn-lg">Get all Members</a>
                            </div>
                                                    </div>
                                                </div>
                            ...
                            <input type="search" class="form-control" placeholder='Filter Members by name here...' id='search'>
                                                </div>
                        ...
                        <div class="row">
                            ...
                            <?php if(isset($_GET['searchstaff'])){
                                if(!empty($_GET['role'])){
                                    ...
                                    $sql = formQuery("SELECT * FROM ceemembers WHERE dphone = '$search'");
                                    if($sql->num_rows>0){ 
                                        $num = 1;
...
<section class="col-xl-3 col-sm-6">
                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <h5 class="font-size-15 mb-1 fullname"><a href="javascript: void(0);" class="text-dark"><?= $row['fullname']?></a></h5>
                                        <p class="text-muted"><?=$row['dphone']?></p>
                                    ...
                                    <div class="card-footer bg-transparent border-top">
                                        <div class="contact-links d-flex font-size-20">
                                            <div class="flex-fill">
                                                <a href="staff-profile?id=<?=$row['id']?>&memberid=<?=$row['memberid']?>"><i class="bx bx-message-square-dots"></i></a>
                                            </div>
                                            <div class="flex-fill">
                                                <a href="edit-staff?id=<?=$row['id']?>&memberid=<?=$row['memberid']?>"><i class="fas fa-pencil-alt"></i></a>
                                            </div>
                                            <div class="flex-fill">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="delete-staff?id=<?=$row['id']?>&memberid=<?=$row['memberid']?>" class="btn btn-danger">Yes, Delete</a>
      </div>
    </div>
  </div>
</div>
<!-- modal -->
                               ...
                               <?php     }
                                  ...
                                  $sql = formQuery("SELECT * FROM ceemembers");
                                ...
                                <div class="card text-center">
                                    ...
                                    <div class="card-footer bg-transparent border-top d-non">
                                        <div class="contact-links d-flex font-size-20">
                                            <!-- <div class="flex-fill">
                                                <a href="staff-profile?id=<?=$row['id']?>&memberid=<?=$row['memberid']?>"><i class="bx bx-message-square-dots"></i></a>
                                            </div> -->
                                            <div class="flex-fill">
                                                <a href="edit-member?id=<?=$row['id']?>&memberid=<?=$row['memberid']?>"><i class="fas fa-pencil-alt"></i></a>
                                            </div>
                                            <div class="flex-fill">
                                            <button type="button" class='btn btn-lg' data-toggle="modal" data-target="#exampleModal<?=$row['id']?>"><i class="fas fa-trash text-danger"></i></button>
...
<div class="modal fade" id="exampleModal<?=$row['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <a href="delete-member?id=<?=$row['id']?>&memberid=<?=$row['memberid']?>" class="btn btn-danger">Yes, Delete</a>
      </div>
    </div>
  </div>
</div>
...
<!-- 
    ...
    <?php unset($_SESSION['memberdelete']) ?>
