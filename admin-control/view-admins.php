                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">All Status Views Admins</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <!-- <li class="breadcrumb-item"><a href="javascript: void(0);">Contacts</a></li> -->
                                            <li class="breadcrumb-ite active"> /Admins' Grid</li>
                                        </ol>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                     <div class="card">
                                                       ...
                                                       <?php if(isset($_SESSION['admindelete']) and $_SESSION['admindelete'] == 'Detail deleted successfully'){ ?>
                                           <div class="alert alert-success alert-dismissible fade show mb-2" role="alert">
                                                <?=$_SESSION['admindelete'] ?>

                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>
                        <?php } ?>

                        <?php if(isset($_SESSION['admindelete']) and $_SESSION['admindelete'] === 'Could not complete this action!'){ ?>
                        ...
                        <div class="row">
                            ...
                            <?php if(isset($_POST['searchstaff'])){
                                if(!empty($_POST['userid'])){
                                    ...
                                    $sql = formQuery("SELECT * FROM ceegeeadmin WHERE userid = '$search'");
                                    if($sql->num_rows>0){
                                       $row = $sql->fetch_assoc(); ?>
...
<section class="col-xl-3 col-sm-6">
                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">Mutual Status Views <?=$row['drole']?></p>
                               ...
                               <?php     }
                                  ...
                                  $sql = formQuery("SELECT * FROM ceegeeadmin");
                                ...
                                <div class="card text-center">
                                    ...
                                    <div class="card-footer bg-transparent border-top">
                                        <div class="contact-links d-flex font-size-20">
                                            ...
                                            <div class="flex-fill">
                                                <a href="edit-admin?id=<?=$row['id']?>&userid=<?=$row['userid']?>"><i class="fas fa-pencil-alt"></i></a>
                                            </div>
                                            <div class="flex-fill">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="delete-admin?id=<?=$row['id']?>&userid=<?=$row['userid']?>" class="btn btn-danger">Yes, Delete</a>
      </div>
    </div>
  </div>
</div>
...
<!-- 
    ...
    <?php unset($_SESSION['admindelete']) ?>
