    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
        ...
        <?php include_once 'siderbar.php' ?>
          ...
          if(isset($_GET['id'])){
            ...
            $sql = formQuery("SELECT * FROM staffs WHERE id= '$id' AND userid = '$userid'");
            $row = $sql->fetch_assoc();
          }
          ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <?php if(isset($_SESSION['staffedit']) and $_SESSION['staffedit'] == 'Record updated successfully!'){ ?>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-ite active"> /Edit Staff's Profile</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form action="edit-staff-process" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                           <label for="firstname">First Name:</label>
                                             <input type="text" class="form-control" placeholder="Enter staff's first name" id="firstname" name='firstname' value='<?=$row['firstname']?>'>
                            ...
                            <div class="form-group mb-3">
                                           <label for="lastname">Last Name:</label>
                                             <input type="text" class="form-control" placeholder="Enter staff's first name" id="lastname" name='lastname' value='<?=$row['lastname']?>'>
                                             <div class="invalid-feedback">
...
<!--                 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="username" placeholder="Enter Username" required name='username' value='<?=$row['username']?>'>  
                                            <div class="invalid-feedback">
                                        ...
                                        <label for="title">Gender:</label>
                                            <select name="gender" id="title" class='form-control'>
                                                <option value="<?=$row['dgender']?>"><?=$row['dgender']?></option>
                                        ...
                                        <div class="mb-3">
                                                        <label for="productdesc">Staff Address</label>
                                                        <textarea class="form-control" id="productdesc" rows="5" placeholder="Enter Staff's Address" name='address'><?=$row['daddress']?></textarea>
                                                    </div>
