                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">All Status View Contacts</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <!-- <li class="breadcrumb-item"><a href="javascript: void(0);">Contacts</a></li> -->
                                            <li class="breadcrumb-item active">Contacts' Grid</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="col-lg-12">
                                ...
                                <?php if(isset($_SESSION['contactdelete']) and $_SESSION['contactdelete'] == 'Contact deleted successfully'){ ?>
                                           <div class="alert alert-success alert-dismissible fade show mb-2" role="alert">
                                                <?=$_SESSION['contactdelete'] ?>

                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>
                        <?php } ?>

                        <?php if(isset($_SESSION['contactdelete']) and $_SESSION['contactdelete'] === 'Could not complete this action!'){ ?>
                        ...
                        <?php } ?>     
                            ...
                            <input type="search" class="form-control" placeholder='Filter contacts by name here...' id='search'>
                                                </div>
                        ...
                        <div class="row">
                            ...
                            <?php if(isset($_GET['searchstaff'])){
                                if(!empty($_GET['role'])){
                                    ...
                                    $sql = formQuery("SELECT * FROM ceecontacts WHERE dphone = '$search'");
                                    if($sql->num_rows>0){ 
                                        $num = 1;
                                ...
                                <div class="card text-center">
                                    ...
                                    <div class="card-footer bg-transparent border-top">
                                        <div class="contact-links d-flex font-size-20">
                                            <!-- <div class="flex-fill">
                                                <a href="staff-profile?id=<?=$row['id']?>&contactid=<?=$row['contactid']?>"><i class="bx bx-message-square-dots"></i></a>
                                            </div> -->
                                            <div class="flex-fill">
                                                <a href="edit-contact?id=<?=$row['id']?>&contactid=<?=$row['contactid']?>"><i class="fas fa-pencil-alt"></i></a>
                                            </div>
                                            <div class="flex-fill">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="delete-staff?id=<?=$row['id']?>&contactid=<?=$row['contactid']?>" class="btn btn-danger">Yes, Delete</a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal<?=$row['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <a href="delete-contact?id=<?=$row['id']?>&contactid=<?=$row['contactid']?>" class="btn btn-danger">Yes, Delete</a>
      </div>
    </div>
  </div>
</div>
...
<!-- 
    ...
    <?php unset($_SESSION['contactdelete']) ?>
