...
// 	method: 'GET',
// 	headers: {
// 		'X-RapidAPI-Key': 'cc571abf74mshcb284ff44da508dp18a1b2jsnfc7ca06199a4',
...
if(countrys){
    countries.countries.map(country=>{
        return countrys.innerHTML += ` <option value="${country.code}">${country.code} &nbsp; &nbsp;   ${country.name}</option>`
    })
}
...
if(myPassword){
    ...
    const genPassword = ()=> {
        ...
        const chars = "0123456789abcde!@#$%^&*()fghijklmnopq23456789rstuvwxyz!@#$%^&*()ABCDEFGHIJKLMNOPQRS!@#$%^&*()TUVWXYZ";
